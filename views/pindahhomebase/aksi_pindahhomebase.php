...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){
  ...
  if ($controller=='pindahhomebase' AND $act=='input'){
...
if(!$result){
  ...
  window.setTimeout(function(){ 
   window.location.replace('../../simpeg.php?controller=pindahhomebase');
  } ,2000); 
 </script>
  ...
  elseif ($controller=='pindahhomebase' AND $act=='update'){
...
if(!$result){
  ...
  elseif ($controller=='pindahhomebase' AND $act=='hapus'){
    if(isset($_POST['hapus_data'])){		  
        ...
        unlink("../file_pindahhomebase/01/".$result['surat_pengantar_permohonan']);
        unlink("../file_pindahhomebase/02/".$result['surat_lolos']);
        unlink("../file_pindahhomebase/03/".$result['surat_keputusan_pemberhentian']);
        unlink("../file_pindahhomebase/04/".$result['sk_pengangkatan']);
        unlink("../file_pindahhomebase/05/".$result['sk_cpns']);
        unlink("../file_pindahhomebase/06/".$result['sk_pns']);
        unlink("../file_pindahhomebase/07/".$result['surat_rekomendasi_pindah']);
        unlink("../file_pindahhomebase/08/".$result['fotocopy_ijazah']);
        unlink("../file_pindahhomebase/09/".$result['jabatan_akademik']);
        unlink("../file_pindahhomebase/10/".$result['print_out']);
