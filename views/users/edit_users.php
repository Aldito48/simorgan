 ...
 <div class="main-content app-content mt-0">
   <div class="side-app">
    <div class="main-container container-fluid">
      ...
      <form method="POST" class="needs-validation" novalidate enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=users&act=update">
	  <?php
         ...
         <div class="form-col">
												...
												<div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" name="username" class="form-control" id="username"
                                                        placeholder="Username" value="<?php echo $r[username];?>"  required>
                                                ...
                                                <div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap"                                                    placeholder="Nama Lengkap" value="<?php echo $r[nama_lengkap];?>" required>
												...
												<div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" name="nip" class="form-control" id="nip"
                                                        placeholder="NIP/NIB" value="<?php echo $r[nip];?>" required>
                                            ...
                                            <select class="form-control select2-show-search form-select" data-placeholder="Hak Akses" name="level" id="level">
                                                    ...
                                                    <input type="text" name="nohp" class="form-control" id="nohp"
                                                        placeholder="No.Telepon/HP" value="<?php echo $r[nohp];?>">
													</div>
