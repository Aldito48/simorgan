        ...
        <div class="col-lg-12 col-md-12">
         <div class="card">
          <div class="card-header">
            <h3 class="card-title">Lihat Data Pengguna Sistem</h3>
          </div>
         <div class="card-body">

      <form method="POST" class="needs-validation" novalidate enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=users">
	  <?php
										...
										<div class="form-col">
											...
											<div class="col-xl-6 mb-3">
                                              <label for="nohp">No.Telepon/HP</label>
                                                <input type="text" name="nohp" class="form-control" id="nohp"placeholder="No.Telepon/HP" value="<?php echo $r[nohp];?>"readonly>
											</div>
									</div>                             
		      <a href="simpeg.php?controller=users" class="btn btn-danger"><i class="fa fa-remove"></i> Kembali</a>
       </form>
     </div>
   </div>
   </div>
