        ...
        <div class="col-lg-12 col-md-12">
         <div class="card">
          <div class="card-header">
            <h3 class="card-title">Edit Data Pangkat/Golongan</h3>
          </div>
         <div class="card-body">

      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=mstpangkatgol&act=update">
	  <?php
         ...
         <div class="form-col">
            <div class="col-xl-6 mb-3">
               <label for="kodegol">Kode Golongan</label>
                 <input type="text" name="kodegol" class="form-control" id="kodegol" placeholder="Kode Golongan" value="<?php echo $r[kodegol];?>" required>
                  <div class="invalid-feedback">Data Kode Jabatan Harus Diisi</div>
             </div>
             <br>
             <div class="col-xl-6 mb-3">
               <label for="namagol">Nama Golongan</label>
                 <input type="text" name="namagol" class="form-control" id="namagol" placeholder="Nama Golongan" value="<?php echo $r[namagol];?>" required>
                  <div class="invalid-feedback">Data Nama Jabatan Harus Diisi</div>
             </div>
             <br>
             <div class="col-xl-6 mb-3">
               <label for="namapangkat">Nama Pangkat</label>
                 <input type="text" name="namapangkat" class="form-control" id="namapangkat" placeholder="Nama Pangkat" value="<?php echo $r[namapangkat];?>" required>
