 ...
 <div class="main-content app-content mt-0">
   <div class="side-app">
    <div class="main-container container-fluid">
      ...
      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=mstunitkerja&act=update">
	  <?php
         ...
         <div class="form-col">
            <div class="col-xl-6 mb-3">
               <label for="kodeunit">Kode Unit</label>
                 <input type="text" name="kodeunit" class="form-control" id="kodeunit" placeholder="Kode Unit" value="<?php echo $r[kodeunit];?>" required>
                  <div class="invalid-feedback">Data Kode Unit Harus Diisi</div>
             </div>
             <br>
             <div class="col-xl-6 mb-3">
               <label for="namaunit">Nama Unit</label>
                 <input type="text" name="namaunit" class="form-control" id="namaunit" placeholder="Nama Unit" value="<?php echo $r[namaunit];?>" required>
