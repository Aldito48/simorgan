...
<?php
  if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
    ...
    switch($act){
      default:
    $izin = mysqli_query($koneksi,"SELECT * FROM mstprovinsi ");
...
?>
    ...
    <div class="side-app">
        <div class="main-container container-fluid">
          ...
          <a  class="btn btn-primary bg-primary-gradient mt-3 btn-pill" data-toggle="tooltip" data-placement="top" title="Tambah" href="?controller=mstprovinsi&act=tambah_mstprovinsi"><i class="fa fa-send"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			  
		  <button class="btn btn-success bg-success-gradient mt-3 btn-pill"  data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_mstprovinsi();" ><i class="fa fa-edit"></i> Edit</button> 
		   <button class="btn btn-warning bg-warning-gradient mt-3 btn-pill"  data-toggle="tooltip" data-placement="top" title="Lihat"  onClick="view_records_mstprovinsi();" ><i class="fa fa-desktop"></i> Lihat</button> 
		  <button class="btn btn-danger bg-danger-gradient mt-3 btn-pill" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_mstprovinsi();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
           ...
           <div class="table-responsive">
             <table class="table table-bordered text-nowrap border-bottom" id="example2">
               ...
               <tbody>
					<?php  
					$no = 1;
					$aks =mysqli_query($koneksi,"select * from mstprovinsi order by id");
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                     <form class="needs-validation" novalidate action="<?php echo $aksi;?>?controller=mstprovinsi&act=input" method="POST">
                                            <div class="form-col">
