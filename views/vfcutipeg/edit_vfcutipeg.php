 ...
 <div class="main-content app-content mt-0">
   <div class="side-app">
    <div class="main-container container-fluid">
      ...
      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=vfcutipeg&act=update">
	  <?php
        ...
        <div class="row">
              ...
              <div class="col-sm-6 col-md-6">
                  <div class="form-group">
                        ...
                        <?php
                            echo "<select class=\"form-control form-select select2\" id=\"keputusan\" name=\"keputusan\" required>
                                    <option value=\"\" disabled selected style=\"display:none;\">Pilih Keputusan</option>";
                                    $sp = mysqli_query($koneksi, "SHOW COLUMNS FROM `usul_cuti` WHERE `field` = 'keputusan'");
                                    while($result = mysqli_fetch_row($sp)){
                                        foreach(explode("','",substr($result[1],6,-2)) as $option){
                                            $selected = ($option === $r['keputusan']) ? 'selected' : '';
                                            echo "<option $selected>$option</option>";
                                        }
                                    }
                            echo "</select>";
                        ?>
                        <div class="invalid-feedback">Data Keputusan Harus Diisi</div>
                  </div>
              </div>
              <br>
              <div class="col-sm-6 col-md-6">
                  <div class="form-group">
                      ...
                      <input type="text" name="keterangan" class="form-control" id="keterangan" placeholder="Keterangan" value="<?=$r['keterangan']?>" required>
                      <div class="invalid-feedback">Data Keterangan Harus Diisi</div>
                  </div>
              </div>
              <br>
          </div>
