 ...
 <div class="main-content app-content mt-0">
   <div class="side-app">
    <div class="main-container container-fluid">
      ...
      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=vfpindahhomebase">
	  <?php
          ...
          <div class="row">
              ...
              <div class="col-sm-6 col-md-6">
                  <div class="form-group">
                      ...
                      <input type="text" name="status" class="form-control" id="status" placeholder="Status" value="<?php echo $r[status];?>" readonly>
                  </div>
              </div>
              <br>
          </div>
          <br>     
		    <a type="submit"  href="simpeg.php?controller=vfpindahhomebase" class="btn btn-danger"><i class="fa fa-remove"></i> Kembali</a>
       </form>
     </div>
   </div>
   </div>
