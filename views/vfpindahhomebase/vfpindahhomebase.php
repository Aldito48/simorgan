...
?>
    ...
    <div class="side-app">
           ...
           <div class="col-lg-12 col-md-12">
             <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Usul Pindah Homebase Verifikasi</h3>
               </div>
               <div class="card-body">
        ...
        {
		?>			  
		  <button class="btn btn-success bg-success-gradient mt-3 btn-pill"  data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_vfpindahhomebase();" ><i class="fa fa-edit"></i> Edit</button> 
		   <button class="btn btn-warning bg-warning-gradient mt-3 btn-pill"  data-toggle="tooltip" data-placement="top" title="Lihat"  onClick="view_records_vfpindahhomebase();" ><i class="fa fa-desktop"></i> Lihat</button> 
		  <button class="btn btn-danger bg-danger-gradient mt-3 btn-pill" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_vfpindahhomebase();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
           ...
           <div class="table-responsive">
             <table class="table table-bordered text-nowrap border-bottom" id="example2">
               ...
               <tbody>
					<?php  
					$no = 1;
					$aks =mysqli_query($koneksi,"select * from usul_pindah_homebase order by id");
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                     <form class="needs-validation" enctype="multipart/form-data" novalidate action="<?php echo $aksi;?>?controller=vfpindahhomebase&act=input" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="surat_pengantar_permohonan" name="surat_pengantar_permohonan" onchange="tampilkanSurat01(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="surat_lolos" name="surat_lolos" onchange="tampilkanSurat02(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="surat_keputusan_pemberhentian" name="surat_keputusan_pemberhentian" onchange="tampilkanSurat03(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="sk_pengangkatan" name="sk_pengangkatan" onchange="tampilkanSurat04(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="sk_cpns" name="sk_cpns" onchange="tampilkanSurat05(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="sk_pns" name="sk_pns" type="file" onchange="tampilkanSurat06(event)" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="surat_rekomendasi_pindah" name="surat_rekomendasi_pindah" onchange="tampilkanSurat07(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="fotocopy_ijazah" name="fotocopy_ijazah" onchange="tampilkanSurat08(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="jabatan_akademik" name="jabatan_akademik" onchange="tampilkanSurat09(event)" type="file" accept=".pdf">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="print_out" name="print_out" onchange="tampilkanSurat10(event)" type="file" accept=".pdf">
