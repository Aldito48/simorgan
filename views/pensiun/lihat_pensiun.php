 ...
 <div class="main-content app-content mt-0">
   <div class="side-app">
    <div class="main-container container-fluid">
      ...
      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=pensiun">
	  <?php
        ...
        <h4>1. Data Pegawai</h4>
          ...
          <br>     
		    <a type="submit"  href="simpeg.php?controller=pensiun" class="btn btn-danger"><i class="fa fa-remove"></i> Kembali</a>
       </form>
     </div>
   </div>
   </div>
