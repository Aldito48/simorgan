        ...
        <div class="col-lg-12 col-md-12">
         <div class="card">
          <div class="card-header">
            <h3 class="card-title">Edit Data Hak Akses</h3>
          </div>
         <div class="card-body">

      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=hakakses&act=update">
	  <?php
         ...
         <div class="form-row">
            <div class="col-xl-6 mb-3">
               <label for="namahakakses">Hak Akses</label>
                 <input type="text" name="namahakakses" class="form-control" id="namahakakses" placeholder="Hak Akses" value="<?php echo $r[nama_hak_akses];?>" required>
