        ...
        <div class="col-lg-12 col-md-12">
         <div class="card">
          <div class="card-header">
            <h3 class="card-title">Lihat Data Dokumen Pensiun</h3>
          </div>
         <div class="card-body">

      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=dokpensiun">
	  <?php
         ...
         <div class="form-col">
           <div class="col-xl-6 mb-3">
            ...
            <div class="col-xl-6 mb-3">
		     ...
		     <a href="simpeg.php?controller=dokpensiun" class="btn btn-danger"><i class="fa fa-remove"></i> Kembali</a>
       </form>
     </div>
   </div>
   </div>
