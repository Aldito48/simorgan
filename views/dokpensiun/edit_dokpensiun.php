        ...
        <div class="col-lg-12 col-md-12">
         <div class="card">
          <div class="card-header">
            <h3 class="card-title">Edit Data Dokumen Pensiun</h3>
          </div>
         <div class="card-body">

      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=dokpensiun&act=update">
	  <?php
         ...
         <div class="form-col">
           <div class="col-xl-6 mb-3">
			<label for="kdpensiun">Kode</label>
              <input type="text" name="kdpensiun" class="form-control" id="kdpensiun" placeholder="Kode" value="<?php echo $r[kdpensiun];?>" required>
                <div class="invalid-feedback">Data Kode Harus Diisi</div>
              </div>
                                               
            <div class="col-xl-6 mb-3">
              <label for="uraianpensiun">Uraian Dokumen</label>
               <input type="text" name="uraianpensiun" class="form-control" id="uraianpensiun" placeholder="Uraian Dokumen" value="<?php echo $r[uraianpensiun];?>" required>
