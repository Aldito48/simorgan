 ...
 <div class="main-content app-content mt-0">
   <div class="side-app">
    <div class="main-container container-fluid">
      ...
      <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?controller=mstkecamatan&act=update">
	  <?php
            ...
            <div class="col-xl-6 mb-3">
             ...
             <div class="col-xl-6 mb-3">
               <label for="kodekec">Kode Kecamatan</label>
                 <input type="text" name="kodekec" class="form-control" id="kodekec" placeholder="Kode Kecamatan" value="<?php echo $r[kodekec];?>" required>
                  <div class="invalid-feedback">Data Kode Kecamatan Harus Diisi</div>
             </div>
             <br>
             <div class="col-xl-6 mb-3">
               <label for="namakec">Nama Kecamatan</label>
                 <input type="text" name="namakec" class="form-control" id="namakec" placeholder="Nama Kecamatan" value="<?php echo $r[namakec];?>" required>
